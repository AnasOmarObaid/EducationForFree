                        ...
                        <ul>
                              <li>
                                    <a href="{{ route('pages.topics.all') }}"
                                          class="{{ request()->routeIs('pages.topics.all') ? 'my-active' : 's' }}">All
                                          topics</a>
                              </li>
                              <li>
                              ...
                              <li>
                                    <a
                                    href="{{ request()->routeIs('pages.topics.testing') ? 'my-active' : 's' }}"
                                    class="{{ request()->routeIs('pages.topics.testing') ? 'my-active' : 's' }}"
                                    >Testing</a>
                              </li>
                              <li>
                                    <a class="{{ request()->routeIs('pages.topics.languages') ? 'my-active' : 's' }}"
                                    href="{{ request()->routeIs('pages.topics.languages') ? 'my-active' : 's' }}">Languages</a>
                              </li>
                              <li>
                                    <a class="{{ request()->routeIs('pages.topics.tooling') ? 'my-active' : 's' }}"
                                    href="{{ request()->routeIs('pages.topics.tooling') ? 'my-active' : 's' }}">Tooling</a>
                              </li>
                              <li>
                                    <a class="{{ request()->routeIs('pages.topics.techniques') ? 'my-active' : 's' }}"
                                    href="{{ request()->routeIs('pages.topics.techniques') ? 'my-active' : 's' }}">Techniques</a>
                              </li>
                        </ul>
                  </div>
            </section>
