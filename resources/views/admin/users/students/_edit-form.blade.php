<x-forms.form action="{{ route('admins.users.students.update', $student) }}" method="POST" enctype="multipart/form-data">
      @csrf
      @method('PUT')
      <div class="row">
                        ...
                        <x-cards.body>
                                                ...
                                                <div class="col-md-4 mb-2">
                                                      <div class="form-group clearfix">
                                                            <div class="icheck-primary d-inline">
                                                                  <input type="checkbox"
                                                                        {{ $student->hasPermission($model . '_' . $permission) ? 'checked' : ''}}
                                                                        name="permissions[]"
                              ...
                              <x-forms.form-group class="mt-4">
                                    ...
                                    <select class="form-control select2" name='activation' style="width: 100%;">
                                          <option value="1" {{ $student->activation == 1 ? 'selected' : '' }}>
                                                Active</option>
                                          <option value="0" {{ $student->activation == 0 ? 'selected' : '' }}>Not
                                                active</option>
                                    </select>
                              </x-forms.form-group>
                        </x-cards.body><!-- card body -->
                        <x-cards.footer class="text-right">
                              <button type="submit" class="btn btn-primary"> <i class="fa-fw fas fa-edit"></i>
                                    Update</button>
                              </button>
                        </x-cards.footer>
                  </x-cards.card>
