<x-forms.form action="{{ route('admins.users.teachers.update', $teacher) }}" method="POST" enctype="multipart/form-data">
      @csrf
      @method('PUT')
      <div class="row">
                        ...
                        <x-cards.body>
                              ...
                              <x-forms.form-group>
                                    ...
                                    <x-forms.input type='text' name='name'
                                          value="{{ old('name', $teacher->name) }}" placeholder="Enter teacher name"
                                          small='show' show_name='teacher' />
                        ...
                        <x-cards.body>
                                                ...
                                                <div class="col-md-4 mb-2">
                                                      <div class="form-group clearfix">
                                                            <div class="icheck-primary d-inline">
                                                                  <input type="checkbox"
                                                                        {{ $teacher->hasPermission($model . '_' . $permission) ? 'checked' : '' }}
                              ...
                              <x-forms.form-group class="mt-4">
                                    ...
                                    <select class="form-control select2" name='activation' style="width: 100%;">
                                          <option value="1" {{ $teacher->activation == 1 ? 'selected' : '' }}>
                                                Active</option>
                                          <option value="0" {{ $teacher->activation == 0 ? 'selected' : '' }}>Not
                                                active</option>
                                    </select>
                              </x-forms.form-group>
                        </x-cards.body><!-- card body -->
