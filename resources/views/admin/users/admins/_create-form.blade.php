<x-forms.form action="{{ route('admins.users.admins.store') }}" method="POST" enctype="multipart/form-data">
      @csrf
      @method('POST')
      <div class="row">
                        ...
                        <x-cards.body>
                              ...
                              <x-forms.form-group>
                                    ...
                                    <x-forms.input type='email' name='email' value="{{ old('email') }}"
                                          placeholder="Enter admin email" small='show' show_name='email' />
                              </x-forms.form-group><!-- form group -->

                              <!-- admin password  -->
                              <x-forms.form-group>
                                    <x-forms.label>Admin password</x-forms.label>
                              ...
                              <x-forms.form-group>
                                    ...
                                    <div class="text-center">
                                          <img id="output" style="max-width:100%" class='mt-3' />
                                    </div>
                              </x-forms.form-group><!-- form group -->
