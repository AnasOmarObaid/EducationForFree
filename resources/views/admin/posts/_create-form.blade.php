<x-forms.form action="{{ route('admins.posts.store') }}" method="POST" enctype="multipart/form-data">
      @csrf
      @method('POST')
      <div class="row">
                        ...
                        <x-cards.body>
                              ...
                              <x-forms.form-group class="mt-4 mb-4">
                                    ...
                                    <small><a href="{{ route('admins.posts-categories.create') }}" target="_blank">
                                                <i class="fa-fw fa fa-plus"></i> create category</a></small>
                              </x-forms.form-group>
